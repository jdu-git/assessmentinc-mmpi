...
def plot_basic_scales(raw_scores, gender, Kscore, convert_basic):
    ...
    # Convert to raw data to T-scores
    T_scores = []
    ...
    ax.text(0.00, -0.03, "T", transform=ax.transAxes, fontsize=14, ha='center', va='top', weight='bold')
    ax2.text(1.00, -0.03, "T", transform=ax2.transAxes, fontsize=14, ha='center', va='top', weight='bold')
